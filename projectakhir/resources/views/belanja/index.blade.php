                ...
                <div class="widget mercado-widget filter-widget">
                    ...
                    <div class="widget-content">
                        <ul class="list-style vertical-list has-count-index">
                            <li class="list-item"><a class="filter-link " href="#">Crumpet
                                    <span>(217)</span></a>
                            </li>
                            <li class="list-item"><a class="filter-link " href="#">Croissant
                                    <span>(179)</span></a>
                            </li>
                            <li class="list-item"><a class="filter-link " href="#">Ciabbata
                                    <span>(79)</span></a>
                            </li>
                            <li class="list-item"><a class="filter-link " href="#">Baguette
                                    <span>(283)</span></a>
                            </li>
                            <li class="list-item"><a class="filter-link " href="#">Bagel
                                    <span>(116)</span></a>
                            </li>
                            <li class="list-item"><a class="filter-link " href="#">Focaccia
                                    <span>(29)</span></a>
                            </li>
                        </ul>
                    </div>
